...
import LogdetLean.GramHafnian.UltimateHiding.H3H4Central.OrderTwoConditional

/-!
# Exact H3 closure from approved A1
...
exact H5 theorem into the checked order-two conditional theorem.
-/
...
theorem coeCorner_centralEventPath_contDiff_external_derived_of_A1
  ...
  exact coeCorner_centralEventPath_contDiff_external_derived_orderTwo_conditional
    hN hboundary
